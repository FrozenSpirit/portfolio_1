...
const Projects = () => {
  const url = 'https://github.com/FrozenSpirit?tab=repositories'
  return (
          ...
          <div className='flex r flex-col w-[100%] '>
            ...
            {frontend.map((proj, index) => (
              <div className='w-full flex flex-col my-3 flex-wrap' id={index}>
                  <h1 onClick={() => window.open(url)} className='md:w-[55%] text-white hover:text-[#16FF00] cursor-pointer hover:underline hover:underline-offset-4 '> 
